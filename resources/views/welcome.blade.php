                        ...
                        <div class="swiper-slide">
                            <div class="shop__collection--card text-center">
                                <a class="shop__collection--link" href="shop.html">
                                    <img style="width: 240px;height: 240px" class="shop__collection--img" src="{{$w->images}}" alt="icon-img">
                            ...
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img" src="{{$w->images}}" alt="product-img">
                                    </a>
