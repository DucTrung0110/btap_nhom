                            ...
                            <form action="#">
                                ...
                                <div class="checkout__content--step section__shipping--address">
                                    ...
                                    <div class="section__shipping--address__content">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-6 col-sm-6 mb-20">
                                                <div class="checkout__input--list ">
                                                    <label class="checkout__input--label mb-10" for="input1"> Name <span class="checkout__input--label__star">*</span></label>
                                                    <input class="checkout__input--field border-radius-5"  id="input1"  type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 mb-20">
                                                <div class="checkout__input--list">
                                                    ...
                                                    <input class="checkout__input--field border-radius-5" id="input4" type="text">
                                                </div>
                                            </div>
